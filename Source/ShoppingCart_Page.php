...
<!-- we should include some php code here -->

<!-- for (all items in shopping cart) -->
<!-- replace 'testing' etc and print the db data in each line-->
      ...
      <tr>
        <th scope="row">1</th>
        <td><img src="https://cdn-icons-png.flaticon.com/512/636/636499.png" alt="Diamond" width="50" height="90" class="d-inline-block align-text-top img-fluid mb-1"></td>
        <td><h5 class="p-name">Indieco bracelet</h5></td>
        <td>
          <div class="d-grid gap-2 d-md-block">
            <!-- <button class="btn btn-dark shoppingCartQButtons" type="button">-</button>
            <div class="shoppingCartQuantity">5</div>
            <button class="btn btn-dark shoppingCartQButtons" type="button">+</button> -->
            <input type = "number" value ="1" min="1" style="width: 7%;">
          </div>
        </td>
        <td><h4 class="p-price">€15</h4></td>
      </tr>
...
<!-- Just samples -->
  ...
  <div class="shoppingCartTotal"><h4 class="p-price">Total: €15</h4></div>  
