      ...
      <div class="row mt-5">
        <div class="col-lg-5 col-md-12 col-12">
          ...
          <div class="small-img-group rounded">
            ...
            <div class="small-img-col rounded">
              <img
                class="small-img"
                src="images/pexels-sunsetoned-6624862.jpg"
                width="100%"
                height="90%"
                alt="Pic"
              />
            ...
            <div class="small-img-col rounded">
              <img
                class="small-img"
                src="images/pexels-olya-kobruseva-4544816.jpg"
                width="100%"
                height="90%"
                alt="Pic"
              />
            ...
            <div class="small-img-col rounded">
              <img
                class="small-img"
                src="images/pexels-leah-kelley-776372.jpg"
                width="100%"
                height="90%"
                alt="Pic"
              />
