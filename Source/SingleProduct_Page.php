...
<head>
  ...
  <link rel="stylesheet" href="styles/style_single_product_page.css" />
  ...
  <section class="container sproduct my-5 pt-5">
    ...
    <div class="row mt-5">
      <div class="col-lg-5 col-md-12 col-12">
        <img class="img-fluid w-10 pb-1 rounded" <?php
                                                  $temp = queryMainUrl($ID);
                                                  $res = ReturnSingleResult($temp);
                                                  echo 'src=" ' . $res . '"';
                                                  ?> src="images/pexels-karolina-grabowska-4889719.jpg" alt="Pic" id="MainImg" />

        <div class="small-img-group rounded">
          <?php
          $temp = queryUrls($ID);
      ...
      <div class="text col-lg-6 col-md-12 col-12">
        <?php
        echo '<h6 class="blockquote">';
        echo 'Home/Jewerly/';
        $temp = getCategory($ID);
        $temp2 = ReturnSingleResult($temp);
        if ($temp2 == 'a') {
          echo 'Anklets</h6>';
        } else if ($temp2 == 'b') {
          echo 'Bracelets</h6>';
