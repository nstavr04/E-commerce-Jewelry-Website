...
$_SESSION['LastPageVisited'] = 'Necklaces_Products_Page.php';
...
<body style="background-color: #f3dbc3;">
  ...
  <section id="Products" class="my-5 pb-5" style="background-color: #f3dbc3;">
    <div class="container text-center mt-5 py-5">
      <h2 class="font-weight-bold">Our Necklaces</h2>
      <hr>
    ...
    <div class="row mx-auto container">
      ...
      for ($i = 1; $i <= $numOfProducts; $i++) {
        ...
        if (ReturnSingleResult($temp) == 'n') {
          ...
          echo  '<img class="img-fluid mb-3" src="' . $res . '" alt="Image of a necklace"/>
          </a>';
