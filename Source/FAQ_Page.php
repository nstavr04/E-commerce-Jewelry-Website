...
<body style="background-color: #f3dbc3">
  ...
  <section id="FAQ-Question">
    ...
    <div>
      ...
      <center>
        <hr style="width:600px; align-self:center">
      </center>
    </div>
      ...
      <div class="card">
        <div class="card-header" style="background-color: #4A2815;">
          <a class="btn" data-bs-toggle="collapse" href="#collapseOne">
            <font color="white"> How can you contact us? </font>
          </a>
        </div>
        <div id="collapseOne" class="collapse" data-bs-parent="#accordion">
          <div class="card-body" style="background-color: #eaccad;">
            You can find on the bootom of the page our social media links as well as our email and telephone number.
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-header" style="background-color: #4A2815;">
          <a class="collapsed btn" data-bs-toggle="collapse" href="#collapseTwo">
            <font color="white"> How do I know if an item is out of stock? </font>
          </a>
        </div>
        <div id="collapseTwo" class="collapse" data-bs-parent="#accordion">
          <div class="card-body" style="background-color: #eaccad;">
            Every item presented in our website, is available for order.
          </div>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-header" style="background-color: #4A2815;">
          <a class="collapsed btn" data-bs-toggle="collapse" href="#collapseThree">
            <font color="white"> How can I receive my products that I ordered? </font>
          </a>
        </div>
        <div id="collapseThree" class="collapse" data-bs-parent="#accordion">
          <div class="card-body" style="background-color: #eaccad;">
            The products will be received to your address via courrier.
          </div>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-header" style="background-color: #4A2815;">
          <a class="collapsed btn" data-bs-toggle="collapse" href="#collapseFour">
            <font color="white"> What products can I find here? </font>
          </a>
        </div>
        <div id="collapseFour" class="collapse" data-bs-parent="#accordion">
          <div class="card-body" style="background-color: #eaccad;">
            You can find bracelets, earrings, anklets, rings, necklaces and candles.
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-header" style="background-color: #4A2815;">
          <a class="collapsed btn" data-bs-toggle="collapse" href="#collapseFive">
            <font color="white"> How much is the delivery cost? </font>
          </a>
        </div>
        <div id="collapseFive" class="collapse" data-bs-parent="#accordion">
          <div class="card-body" style="background-color: #eaccad;">
            The delivery cost is at the fixed amount of 3 euros.
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-header" style="background-color: #4A2815;">
          <a class="collapsed btn" data-bs-toggle="collapse" href="#collapseSix">
            <font color="white"> Do you ship in Cyprus only? </font>
          </a>
        </div>
        <div id="collapseSix" class="collapse" data-bs-parent="#accordion">
          <div class="card-body" style="background-color: #eaccad;">
            Yes, we ship everywhere in Cyprus but not abroad.
          </div>
        </div>
      </div>
    </div>
