...
<body style="background-color: #f3dbc3;">
                ...
                <nav class="navbar navbar-light ">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="index.php">
                            <img src="https://cdn-icons-png.flaticon.com/512/636/636499.png" alt="Diamond" width="30"
    ...
    <main style="margin: 5%;">
        <div class="card" style="max-width: 1000px; font-size: 36px; font-weight: 100; line-height: 250%; margin: auto;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="https://images.pexels.com/photos/9637585/pexels-photo-9637585.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt="Girl wearing diamonds"
                ...
                <div class="col-md-8 bg-dark text-white">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <b>Facebook: </b>
                            <a class="text-white" href="https://www.facebook.com/Pileofjewelry">Pile of Jewelry</a>

                            <br>

                            <b>Instagram: </b>
                            <a class="text-white" href="https://www.instagram.com/pile_of_jewelry_/">Pile of Jewelry</a>

                            <br>

                            <b>Email: </b>
                            <a class="text-white"
                                href="mailto:pileofjewelry@gmail.com?subject=Feedback&body=Hello,">pileofjewelry@gmail.com</a>

                            <br>

                            <b>Phone: </b>+357 96425326
                        </p>
                        <!-- <p class="card-text">
                            <small class="text-muted">Response During working times</small>
                        </p> -->
                    </div>
                </div>
            </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4" style="text-align: center;">
                            ...
                            <p>
                                ...
                                </svg> <a href="https://www.instagram.com/pile_of_jewelry_/"
