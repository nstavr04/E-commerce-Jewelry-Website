...
<head>
  ...
  <title>Pile of Jewelry Home Page.</title>
</head>
...
<body style="background-color: #f3dbc3;">
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel" data-bs-pause="false">
      <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="3000">
          <img src="https://images.pexels.com/photos/691046/pexels-photo-691046.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" class="d-block w-100" alt="image">
        </div>
        <div class="carousel-item" data-bs-interval="3000">
          <img src="https://images.pexels.com/photos/147637/pexels-photo-147637.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" class="d-block w-100" alt="image">
        </div>
        <div class="carousel-item" data-bs-interval="3000">
          <img src="https://images.pexels.com/photos/3641056/pexels-photo-3641056.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" class="d-block w-100" alt="image">
        </div>
      </div>
    </div>
  </section>
  <!-- Completed -->
  <section id="After carousel logo and title">
    <div class="px-4 py-5 my-5 text-center">
      <img class="d-block mx-auto mb-4" src="https://cdn-icons-png.flaticon.com/512/636/636499.png" alt="pileofjewelry-logo" width="72" height="57">
      <h1 class="display-5 fw-bold">Pile of Jewelry</h1>
      <div class="col-lg-6 mx-auto">
        <p class="lead mb-4">Handmade stainless steel jewelry and Candle shop. <br> Door to door delivery all over Cyprus.</p>
      </div>
    </div>
  </section>
  <!-- Completed -->
  <section id="ImagesBelowMainPopular" style="background-color: #f3dbc3;">
    <div class="container px-4 py-5" id="custom-cards">
      <h2 class="pb-2 border-bottom border-secondary">Popular</h2>
  ...
  <!-- Completed -->
  <section id="ImagesBelowMainLatest" style="background-color: #f3dbc3;">
    <div class="container px-4 py-5" id="custom-cards">
      <h2 class="pb-2 border-bottom border-secondary">Latest</h2>
      <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
        <!-- First Img -->
        <div class="col">
          <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg">
