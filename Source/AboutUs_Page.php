...
<head>
  ...
  <link rel="stylesheet" href="styles/style_AboutUs_page.css" />
...
<body style="background-color: #f3dbc3">
  ...
  <main style="margin: 5%;">
    <div class="card" style="max-width: 1000px; font-size: 30px; font-weight: 100; line-height: 250%; margin: auto;">
      <div class="row g-0">
        <div class="col-md-4">
          <img src="https://images.pexels.com/photos/1454172/pexels-photo-1454172.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt="Girl wearing diamonds" class="img-fluid rounded-start" />
        </div>
